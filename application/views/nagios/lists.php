    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <a href="<?php echo base_url('dashboard') ?>" title="" class="btn btn-sm  btn-round fa fa-close">
              </a>
          </ol>
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <iframe src="http://192.168.1.100/nagios/cgi-bin/status.cgi?host=all" frameborder="0" style="overflow:hidden;overflow-x:hidden;overflow-y:hidden;height:100%;width:100%;position:absolute;top:0px;left:0px;right:0px;bottom:0px" height="100%" width="100%"></iframe>
          </div>
        </div>
      </div>
